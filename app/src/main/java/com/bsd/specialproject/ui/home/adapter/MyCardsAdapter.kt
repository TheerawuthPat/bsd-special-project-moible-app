...
import com.bsd.specialproject.ui.home.viewholder.MyCreditCardViewHolder

class MyCardsAdapter(
    private val onClick: (CreditCardClick) -> Unit
) : ListAdapter<CreditCardModel, MyCreditCardViewHolder>(DIFF_COMPARATOR) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyCreditCardViewHolder {
        return MyCreditCardViewHolder.from(parent, onClick)
    }

    override fun onBindViewHolder(holder: MyCreditCardViewHolder, position: Int) {
